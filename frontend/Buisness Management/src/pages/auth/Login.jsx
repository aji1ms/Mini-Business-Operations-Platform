...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Briefcase, Loader2, } from 'lucide-react';
import { useDispatch, useSelector } from 'react-redux';
import { useNavigate } from 'react-router-dom';
import { validateEmail, validatePassword } from '../../utils/helper';
import { loginStaff } from '../../Redux/slices/staff/staffSlice';
...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        if (!validatePassword(password)) {
            setErr("Password must be at least 6 characters with letters and numbers");
            return;
        }
        await dispatch(loginStaff({ email, password })).unwrap();
